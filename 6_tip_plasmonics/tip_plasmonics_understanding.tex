...
%Removal of a portion of the back surface is equivalent in some sense to elongating the particle so a redshift in the modes is expected. Weak coupling (self-interaction) between the back sphere surface and the tip will also redshift resonances slightly further. The result is a dominant quadrupole-like plasmon around \SI{600}{nm} and a weak dipole further out in the NIR.
