...
%		\put(0,-235) {\includegraphics[width=\paperwidth, clip=true, trim=0 250 0 0]{figures/chapter_cover.jpg}}
		\put(0,-220) {\includegraphics[width=\paperwidth, clip=true, trim=0 25 0 0]{../chapter_covers/introduction_cover.png}}
		\put(280,-195) {\begin{minipage}{0.65\textwidth}\flushright\singlespace\fontsize{9pt}{1em}\selectfont\color{white} Windows of the Robinson College chapel. Metallic nanoparticle impurities historically led to the vibrant colours associated with stained glass.\end{minipage}}
	}
}
