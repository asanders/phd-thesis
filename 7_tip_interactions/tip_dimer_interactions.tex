...
\centering
\begin{tikzpicture}
\node [below left] at (-0.1,0) {\includegraphics{figures/classical_tip_dimer_2}};
\node [below right] at (0.1,0) {\includegraphics{figures/classical_tip_dimer_1}};
\node [below left] at (-7.55,-0.1) {\textbf{a}};
\node [below right] at (0.25,-0.1) {\textbf{b}};
\end{tikzpicture}
