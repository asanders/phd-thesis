...
\includegraphics[height=0.5\textwidth, clip=true, trim=50 60 0 0]{figures/literature/nl049681cf00002}\hspace{0pt}\includegraphics[height=0.5\textwidth, clip=true, trim=77 60 0 0]{figures/literature/nl049681cf00003}
\caption[Hybridised plasmon energy shifts for spherical AuNP dimers \cite{nordlander2004}]{\textbf{Hybridised plasmon energy shifts for spherical AuNP dimers \cite{nordlander2004}.} Homodimer (left) and heterodimer (right) plasmon energies are calculated in both the axial (top) and transverse (bottom) coupling configurations. Spheres are \SI{20}{nm} in diameter in the homodimer and 10 and \SI{20}{nm} in the heterodimer, and $D$ is the centre of mass separation.}
