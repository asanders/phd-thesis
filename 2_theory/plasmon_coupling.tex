...
\node [below right] at (4.7,-0.05) {\textbf{b}};
\node [below right] at (10.65,-0.05) {\textbf{c}};
\end{tikzpicture}
...
\centering
\begin{tikzpicture}
\node [below right] at (0,0) {\includegraphics[width=0.7\textwidth]{figures/literature/quantum_plasmonics}};
\node [below right] at (0,-0.3) {\textbf{a}};
\node [below right] at (0,-6.6) {\textbf{b}};
{\fontsize{7pt}{1em}\selectfont
\node [below right] at (3.4,-11.92) {$\mathsf{<0.27}$};
\node [below right] at (2,-11.92) {$\mathsf{-0.3}$};
}
\end{tikzpicture}
...
\node [below left] at (-5.5,0.1) {\textbf{a}};
\node [below left] at (0.8,0.1) {\textbf{b}};
\end{tikzpicture}
